...
from lbm2.positional_embedding.rotary import (
    RotaryEmbedding, 
    RotaryWithCast, 
    rotate_half, 
...
class TestRotaryEmbedding:
    ...
    @pytest.mark.parametrize("dim_model,seq_len", [
        (64, 128),    # Small
        (128, 512),   # Medium  
        (256, 1024),  # Large
        (32, 64),     # Minimal
...
class TestRotaryWithCast:
    ...
    @pytest.mark.parametrize("q_dtype,v_dtype", [
...
class TestGetPosEmbed:
    ...
    @pytest.mark.parametrize("pos_type,expected_class", [

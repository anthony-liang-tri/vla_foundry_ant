...
class TestPreprocessRoboticsToTarSafety:
    ...
    @patch("vla_foundry.data.scripts.preprocessing.preprocess_robotics_to_tar.check_directory_has_files_with_prefix")
    ...
    def test_main_fails_with_existing_episode_files(self, mock_parse, mock_check_dir):
        ...
        mock_check_dir.assert_called_once_with("s3://bucket/output/episodes", "episode_")

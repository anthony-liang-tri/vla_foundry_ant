...
materialize_task data/robosuite_lift_full_horizon32 "lift the red cube off the table"
materialize_task data/robosuite_can_full_horizon32 "pick the coke can and place it in the bin"
materialize_task data/robosuite_square_full_horizon32 "pick up the square nut and place it on the square peg"
...
torchrun --nproc_per_node=1 --master_port=29521 \
    vla_foundry/main.py \
    --config_path train_robosuite_flow_lift_can_square_full_state_vision_ft_lerobot_style_100k.yaml \
    2>&1 | tee -a outputs/robosuite_flow_lift_can_square_full_state_vision_ft_lerobot_style_100k_train.log

#!/bin/bash
#
# Launch VLA ablation_30ksteps SageMaker training jobs from resolved config files.
# Distributes jobs across queues ml, vla, tri-cam-humanoid with ratio 2:2:1.
#
# Usage:
#   ./vla_foundry/tri/ablations/vla/launch_ablation_30ksteps_sagemaker.sh [--dry-run]
#   ./vla_foundry/tri/ablations/vla/launch_ablation_30ksteps_sagemaker.sh --task RedBell --dry-run
#   ./vla_foundry/tri/ablations/vla/launch_ablation_30ksteps_sagemaker.sh --ablation nominal
#
...
CONFIG_DIR="vla_foundry/tri/ablations/vla/ablation_30ksteps"
...
get_short_name() {
    ...
    case "$ablation" in
        ...
        "lr_2e-4") short_ablation="lr2e4" ;;
        "lr_5e-4") short_ablation="lr5e4" ;;
        "lr_1e-3") short_ablation="lr1e3" ;;
    ...
    echo "vla30k-${short_task}-${short_ablation}"
}

...
--type "spartan" \
--source_episodes "[
    's3://robotics-manip-lbm/efs/data/tasks/BimanualPlaceDustpanOnPegboard/wollaston/real/bc/teleop/2025-09-30T13-49-44-07-00/diffusion_spartan/',
    's3://robotics-manip-lbm/efs/data/tasks/BimanualPlaceDustpanOnPegboard/wollaston/real/bc/teleop/2025-11-18T10-30-19-08-00/diffusion_spartan/',
    ]" \
--output_dir "s3://tri-ml-datasets-uw2/vla_foundry_datasets/toolhang_202602/BimanualPlaceDustpanOnPegboard" \

...
--type "spartan" \
--source_episodes "[
    's3://robotics-manip-lbm/efs/data/tasks/BimanualPlaceTapeMeasureOnPegboard/wollaston/real/bc/teleop/2025-10-01T11-10-22-07-00/diffusion_spartan/',
    ]" \
--output_dir "s3://tri-ml-datasets-uw2/vla_foundry_datasets/toolhang_202602/BimanualPlaceTapeMeasureOnPegboard" \

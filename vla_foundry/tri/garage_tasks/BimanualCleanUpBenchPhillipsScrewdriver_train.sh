...
--remote_sync s3://tri-ml-datasets-uw2/lbm2_vla/model_checkpoints/diffusion_policy/BimanualCleanUpBenchPhillipsScrewdriver \
--num_checkpoints 5 \
--total_train_samples 100_000_000 \
--data.dataset_manifest "['s3://tri-ml-datasets-uw2/vla_foundry_datasets/garage_02242026/BimanualCleanUpBenchPhillipsScrewdriver/shards/manifest.jsonl',]" \
--data.dataset_statistics "['s3://tri-ml-datasets-uw2/vla_foundry_datasets/garage_02242026/BimanualCleanUpBenchPhillipsScrewdriver/shards/stats.json',]" \

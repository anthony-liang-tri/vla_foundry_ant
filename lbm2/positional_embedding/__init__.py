...
def get_pos_embed(model_configs):
    ...
    elif model_configs.positional_embedding_type == "rotary_float32":
        return Float32Module(RotaryWithCast(head_dim, model_configs.max_seq_len), cast_outputs_back=True)

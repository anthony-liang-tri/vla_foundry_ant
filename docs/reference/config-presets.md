...
| `diffusion_policy_g1.yaml` | `diffusion_policy` | G1 variant: unfrozen CLIP image encoder, tighter clamp range | `config_presets/models/diffusion_policy_g1.yaml` |
| `maniflow.yaml` | `maniflow` | DP3 encoder + 12-layer DiTX predictor + consistency flow | `config_presets/models/maniflow.yaml` |
...
| `maniflow.yaml` | `robotics` | ManiFlow data params with point cloud support, color jitter augmentation | `config_presets/data/maniflow.yaml` |
...
Stored in `config_presets/data/unitree_g1/`.

| Preset | Description | File |
|--------|-------------|------|
| `g1_data_params.yaml` | Unitree G1 humanoid data (ee poses, joint states, hand joints) | `data/unitree_g1/g1_data_params.yaml` |
| `g1_data_camera_names.yaml` | G1 camera configuration | `data/unitree_g1/g1_data_camera_names.yaml` |
| `g1_action_fields.yaml` | G1 action field definitions | `data/unitree_g1/g1_action_fields.yaml` |
| `g1_language_annotations.yaml` | G1 language instruction types | `data/unitree_g1/g1_language_annotations.yaml` |
| `g1_mcap_topics.yaml` | G1 MCAP topic definitions | `data/unitree_g1/g1_mcap_topics.yaml` |

### Humanoid Everyday

Stored in `config_presets/data/humanoid_everyday/`.

| Preset | Description | File |
|--------|-------------|------|
| `humanoid_everyday_data_params.yaml` | Humanoid everyday tasks (head camera, arm/leg/hand joints, IMU) | `data/humanoid_everyday/humanoid_everyday_data_params.yaml` |
| `humanoid_everyday_preprocessing_params.yaml` | Preprocessing parameters for humanoid everyday data | `data/humanoid_everyday/humanoid_everyday_preprocessing_params.yaml` |
...
| `g1_preprocessing_params_1past_47future_30hz.yaml` | G1 extended horizon at 30Hz, 1 past + 47 future, zero-padded | `data/g1_preprocessing_params_1past_47future_30hz.yaml` |
...
| `maniflow.yaml` | ManiFlow hparams | `lr: 5e-4`, `loss: mse`, `grad_clip: 1.0`, `lr_cooldown_end: 1e-5` | `hparams/maniflow.yaml` |
...
| `diffusion_policy_unitree_g1.yaml` | Diffusion Policy | Unitree G1 humanoid | `training_jobs/diffusion_policy_unitree_g1.yaml` |
| `diffusion_policy_humanoid_everyday.yaml` | Diffusion Policy | Humanoid everyday tasks | `training_jobs/diffusion_policy_humanoid_everyday.yaml` |
| `maniflow_example.yaml` | ManiFlow | Example with placeholder paths | `training_jobs/maniflow_example.yaml` |
...
|   |-- g1_preprocessing_params_1past_47future_30hz.yaml
|   |-- mmt_preprocessing_params_1past_14future.yaml
|   |-- mmt_preprocessing_params_1past_14future_left_arm_only.yaml
|   |-- lbm/
|   |-- mmt/
|   |-- unitree_g1/
|   |-- humanoid_everyday/
...
+-- training_jobs/
    ...
    |-- diffusion_policy_mmt.yaml
    |-- diffusion_policy_mmt_sample.yaml
    |-- diffusion_policy_unitree_g1.yaml
    |-- diffusion_policy_humanoid_everyday.yaml
    |-- maniflow_example.yaml
